...
/*
 * TODO : Lets add in oAuth /oAuth type secuity
 * 
 */
...
/*
|--------------------------------------------------------------------------
| REST Use Logins DB - added by C Serna for Phalare Projects 07/22/2011
|--------------------------------------------------------------------------
|
| if set true the logins usernames  will be ignored
| 
|
|
*/
$config['rest_valid_logins_use_db'] = TRUE;


/*
|--------------------------------------------------------------------------
| REST  Logins Salt - added by C Serna for Phalare Projects 07/22/2011
|--------------------------------------------------------------------------
|
| Salt for key passwords
 ******* WARNING *****************
 * changing this value may have undisired impact *
 * TODO Automate this creation on install 
 * 
 * *****************************
| 
|
|
*/
$config['rest_valid_logins_salt'] = '9uy65t4iouJ8S1Yr';
...
|
*/
$config['rest_keys_table'] = 'pigeon_keys';
...
| Admin API Key 
|--------------------------------------------------------------------------
| We Need this key to build the initial API Key generation 
| Basic chicken egg ;)
| Added By csera 07/28/2011
|
|
 * 
 */

$config['admin_API_Key'] = '9uy65t4iouJ8S1Yr';
/*
|--------------------------------------------------------------------------
| REST Key Length
|--------------------------------------------------------------------------
...
|
*/
$config['rest_logs_table'] = 'pigeon_logs';
...
|
*/
$config['rest_limits_table'] = 'pigeon_limits';
